...
#|
Este código en Lisp utiliza lambdas para calcular y mostrar el área de un trapecio a partir de las longitudes de la base mayor, 
...
y se utiliza funcall para ejecutar el programa.
 |#