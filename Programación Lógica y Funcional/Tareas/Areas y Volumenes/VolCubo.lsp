...
#|
Este código Lisp define una variable global *volumencubo* que almacena una función anónima (lambda) para calcular el volumen de un cubo. 
...
y muestra el resultado en unidades cúbicas.
 |#