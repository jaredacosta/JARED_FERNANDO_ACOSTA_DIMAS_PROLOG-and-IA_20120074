...
#|
Este código define una función llamada pedirDatos que solicita al usuario la longitud del lado de un tetraedro 
...
El resultado se formatea y muestra en la salida estándar.
|#